...
export function Hero(): HeroData {
    return {
        ...
        content: (<>
            ...
            <h1 className="title">Dovetail Homerton</h1>
        </>)
    };
}
    ...
    return (<>
        <Layout hero={Hero}>
            <section className="secondary">
                <div className="intro">
                    <h2>Dovetail Homerton</h2>
                    <p>Nestled in the heart of Homerton, a stone’s throw away from Hackney’s vibrant nightlife scene, you’ll discover Dovetail Homerton – a spacious bar that beckons both locals and curious wanderers alike.</p>
                    ...
                    <p>Explore Dovetail Homerton, Homerton’s best-kept secret.</p>
                </div>
            </section>
