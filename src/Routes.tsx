  ...
  return (<>
    <BrowserRouter>
      <ReactRoutes>
        ...
        <Route path="/bars/covent-garden/bookings" element={<BookingsCoventGarden.Content />} />
        <Route path="/bars/covent-garden/private-hire" element={<BarsCoventGardenPrivateHire.Content />} />
        <Route path="/bars/clapton" element={<BarsClapton.Content />} />
        <Route path="/bars/clapton/bookings" element={<BookingsClapton.Content />} />
